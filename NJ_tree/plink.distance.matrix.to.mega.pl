#perl plink.distance.matrix.to.mega.pl only_1_ind_WGS_RNA_COMMON_IND_njtree.mdist.id only_1_ind_WGS_RNA_COMMON_IND_njtree.mdist 3822 only_1_ind_WGS_RNA_COMMON_IND_njtree
#3822为输入文件的个体数

#!/usr/bin/perl
=pod
filter by missing rate and maf and exclude sex chromosome and scaffolds
plink --bfile filter --distance-matrix --out mdis
=cut
use strict;
